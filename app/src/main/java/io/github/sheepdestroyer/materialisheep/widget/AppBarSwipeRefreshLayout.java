...
/**
 * Minor extension to {@link SwipeRefreshLayout} that is appbar-aware, only enabling when appbar has
 * been fully expanded. This class assumes activity layout contains an {@link AppBarLayout} with
 * {@link R.id#appbar}
 */
