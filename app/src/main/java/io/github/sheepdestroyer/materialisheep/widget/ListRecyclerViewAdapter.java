...
public abstract class ListRecyclerViewAdapter<
  ...
  private void openItem(T item) {
    Intent intent =
        new Intent(mContext, ItemActivity.class)
            .putExtra(ItemActivity.EXTRA_CACHE_MODE, getItemCacheMode())
            .putExtra(ItemActivity.EXTRA_ITEM, item)
            .putExtra(ItemActivity.EXTRA_OPEN_COMMENTS, true);
    mContext.startActivity(
        mMultiWindowEnabled ? AppUtils.multiWindowIntent((Activity) mContext, intent) : intent);
  }
  ...
  public static class ItemViewHolder extends RecyclerView.ViewHolder {
    ...
    ItemViewHolder(View itemView) {
      ...
      mCardElevation =
          itemView.getContext().getResources().getDimensionPixelSize(R.dimen.cardview_elevation);
    }
    ...
    public void bind(
      ...
      mCardView.setCardElevation(
          selected ? mCardElevation * 2 : (cardViewEnabled ? mCardElevation : 0));
