...
public class Preferences {
  ...
  private static final BoolToStringPref[] PREF_MIGRATION =
      new BoolToStringPref[] {
        new BoolToStringPref(
  ...
  public static StoryViewMode getDefaultStoryView(Context context) {
    String pref =
        get(context, R.string.pref_story_display, R.string.pref_story_display_value_article);
  ...
  public static boolean isSinglePage(Context context, String displayOption) {
    return !TextUtils.equals(
        displayOption, context.getString(R.string.pref_comment_display_value_multiple));
  }
  ...
  public static boolean isAutoExpand(Context context, String displayOption) {
    return TextUtils.equals(
        displayOption, context.getString(R.string.pref_comment_display_value_single));
  }
   ...
   */
  public static void setPopularRange(
      Context context, @AlgoliaPopularClient.Range @NonNull String range) {
  ...
  public static boolean isLaunchScreenLast(Context context) {
    return TextUtils.equals(
        context.getString(R.string.pref_launch_screen_value_last), getLaunchScreen(context));
  }
  ...
  public static class BoolToStringPref {
    ...
    @Synthetic
    BoolToStringPref(
        @StringRes int oldKey, boolean oldDefault, @StringRes int newKey, @StringRes int newValue) {
      this.oldKey = oldKey;
  ...
  public static class Theme {
    ...
    public static void apply(Context context, boolean dialogTheme, boolean isTranslucent) {
      ...
      if (dialogTheme) {
        context.setTheme(
            AppUtils.getThemedResId(context, androidx.appcompat.R.attr.alertDialogTheme));
      }
    }
  ...
  public static class Observable {
    ...
    public void subscribe(
        Context context, @NonNull Observer observer, @NonNull int... preferenceKeys) {
