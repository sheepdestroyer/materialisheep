 ...
 * functionality, such as setting up the RecyclerView, handling scroll events, and managing adapter
 * state.
 */
abstract class BaseListFragment extends BaseFragment implements Scrollable {
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    final int verticalMargin =
        getResources().getDimensionPixelSize(R.dimen.cardview_vertical_margin);
    final int horizontalMargin =
        getResources().getDimensionPixelSize(R.dimen.cardview_horizontal_margin);
    ...
    mScrollableHelper =
        new KeyDelegate.RecyclerViewHelper(
            mRecyclerView, KeyDelegate.RecyclerViewHelper.SCROLL_PAGE);
  }
  ...
  private void showPreferences() {
    ...
    args.putIntArray(
        PopupSettingsFragment.EXTRA_XML_PREFERENCES,
