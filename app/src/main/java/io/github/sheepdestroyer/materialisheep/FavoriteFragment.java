...
public class FavoriteFragment extends BaseListFragment
        ...
        .setOnLongClickListener(
            v -> {
              ...
              bookmark.setVisibility(
                  bookmark.getVisibility() == View.VISIBLE ? View.INVISIBLE : View.VISIBLE);
              return true;
            });
  ...
  protected void prepareOptionsMenu(Menu menu) {
    ...
    menu.findItem(R.id.menu_search)
        .setVisible(!TextUtils.isEmpty(mFilter) || getAdapter().getItemCount() > 0);
    if (getAdapter().getItemCount() > 0) {
  ...
  private void clear() {
    mAlertDialogBuilder
        ...
        .setPositiveButton(
            android.R.string.ok, (dialog, which) -> mFavoriteManager.clear(getActivity(), mFilter))
