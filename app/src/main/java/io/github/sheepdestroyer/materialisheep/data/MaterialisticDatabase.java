...
public abstract class MaterialisticDatabase extends RoomDatabase {
  ...
  @VisibleForTesting
  protected static Builder<MaterialisticDatabase> setupBuilder(
      Builder<MaterialisticDatabase> builder) {
  ...
  public static class Readable {
    ...
    public boolean equals(Object o) {
      ...
      if (itemId != null ? !itemId.equals(readable.itemId) : readable.itemId != null) return false;
  ...
  static class DbConstants {
    ...
    static final String SQL_CREATE_SAVED_TABLE =
        "CREATE TABLE saved (_id INTEGER NOT NULL PRIMARY KEY, itemid TEXT, url TEXT, title TEXT,"
            + " time TEXT)";
    ...
    static final String SQL_INSERT_READABILITY_READABLE =
        "INSERT INTO readable SELECT * FROM readability";
