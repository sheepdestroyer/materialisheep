...
public class SettingsActivity extends DrawerActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.drawer_display)
        .setOnClickListener(
            v ->
                startActivity(
                    new Intent(SettingsActivity.this, PreferencesActivity.class)
                        .putExtra(PreferencesActivity.EXTRA_TITLE, R.string.display)
                        .putExtra(
                            PreferencesActivity.EXTRA_PREFERENCES, R.xml.preferences_display)));
            ...
            v ->
                startActivity(
                    new Intent(SettingsActivity.this, PreferencesActivity.class)
                        ...
                        .putExtra(
                            PreferencesActivity.EXTRA_PREFERENCES, R.xml.preferences_offline)));
    ...
    findViewById(R.id.menu_comments)
        .setOnClickListener(
            v ->
                startActivity(
                    new Intent(SettingsActivity.this, PreferencesActivity.class)
                        ...
                        .putExtra(
                            PreferencesActivity.EXTRA_PREFERENCES, R.xml.preferences_comments)));
    findViewById(R.id.menu_readability)
        .setOnClickListener(
            v ->
                startActivity(
                    new Intent(SettingsActivity.this, PreferencesActivity.class)
                        ...
                        .putExtra(
                            PreferencesActivity.EXTRA_PREFERENCES, R.xml.preferences_readability)));
    findViewById(R.id.drawer_about)
        .setOnClickListener(
            v -> startActivity(new Intent(SettingsActivity.this, AboutActivity.class)));
    findViewById(R.id.drawer_release)
        .setOnClickListener(
            v -> startActivity(new Intent(SettingsActivity.this, ReleaseNotesActivity.class)));
  }
