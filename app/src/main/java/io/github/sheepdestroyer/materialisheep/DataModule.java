...
public class DataModule {
  ...
  public UserServices provideUserServices(
      Call.Factory callFactory, @Named(IO_THREAD) Scheduler ioScheduler) {
  ...
  /**
   * Provides a singleton instance of {@link SavedStoriesDao}.
   *
   * @param database The {@link MaterialisticDatabase} instance.
   * @return The singleton instance of {@link SavedStoriesDao}.
   */
  @Provides
  @Singleton
