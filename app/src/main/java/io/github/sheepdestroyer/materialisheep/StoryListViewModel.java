...
public class StoryListViewModel extends ViewModel {
  ...
  private final io.reactivex.rxjava3.disposables.CompositeDisposable mDisposables =
   ...
   */
  public LiveData<Pair<Item[], Item[]>> getStories(
      String filter, @ItemManager.CacheMode int cacheMode) {
    if (mItems == null) {
  ...
  void setItems(Item[] items) {
    mItems.setValue(
        Pair.create(mItems.getValue() != null ? mItems.getValue().second : null, items));
  }
}
