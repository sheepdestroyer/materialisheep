...
public class ItemPagerAdapter extends androidx.viewpager2.adapter.FragmentStateAdapter {
  ...
  public ItemPagerAdapter(
      androidx.fragment.app.FragmentActivity fragmentActivity, @NonNull Builder builder) {
  ...
  public CharSequence getPageTitle(int position) {
    if (position == 0) {
      if (mItem instanceof Item) {
        ...
        return mContext.getResources().getQuantityString(R.plurals.comments_count, count, count);
      }
  ...
  /**
   * Helper to generate the fragment tag used by ViewPager2's FragmentStateAdapter.
   *
