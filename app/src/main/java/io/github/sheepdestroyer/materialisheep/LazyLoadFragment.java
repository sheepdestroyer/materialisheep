...
public abstract class LazyLoadFragment extends BaseFragment {
  public static final String EXTRA_EAGER_LOAD =
      LazyLoadFragment.class.getName() + ".EXTRA_EAGER_LOAD";
  public static final String EXTRA_RETAIN_INSTANCE =
      WebFragment.class.getName() + ".EXTRA_RETAIN_INSTANCE";
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (!mViewModel.isInitialized()) {
      ...
      if (savedInstanceState != null) {
        ...
        boolean eager =
            getArguments() != null && getArguments().getBoolean(EXTRA_EAGER_LOAD)
   ...
   * but before any saved state has been restored into the view.
   */
  @Override
