...
public abstract class DrawerActivity extends ThemedActivity {
    ...
    moreToggle.setOnClickListener(
        v -> {
          if (moreContainer.getVisibility() == View.VISIBLE) {
            moreToggle.setTextColor(
                ContextCompat.getColor(
                    DrawerActivity.this,
                    AppUtils.getThemedResId(
                        DrawerActivity.this, android.R.attr.textColorTertiary)));
            ...
            moreToggle.setTextColor(
                ContextCompat.getColor(
                    DrawerActivity.this,
                    AppUtils.getThemedResId(
                        DrawerActivity.this, android.R.attr.textColorSecondary)));
            moreToggle.setCompoundDrawablesWithIntrinsicBounds(
                R.drawable.ic_dummy_transparent_24dp, 0,
  ...
  private void showLogin() {
    Account[] accounts = AccountManager.get(this).getAccountsByType(BuildConfig.APPLICATION_ID);
  ...
  private void confirmLogout() {
    mAlertDialogBuilder
        ...
        .setPositiveButton(
            android.R.string.ok, (dialog, which) -> Preferences.setUsername(this, null))
        .show();
  }
