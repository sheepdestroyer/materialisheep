...
public abstract class ThemedActivity extends AppCompatActivity {
  ...
  protected void onPostCreate(@Nullable Bundle savedInstanceState) {
    ...
    mThemeObservable.subscribe(
        this,
        (key, contextChanged) -> onThemeChanged(key),
        R.string.pref_theme,
        R.string.pref_daynight_auto);
  }
  ...
  /**
   * Called after {@link #onRestoreInstanceState(Bundle)}, {@link #onRestart()}, or {@link
      ...
      setTaskDescription(
          new ActivityManager.TaskDescription(
              ...
              ContextCompat.getColor(
                  this, AppUtils.getThemedResId(this, androidx.appcompat.R.attr.colorPrimary))));
    }
  }
}
