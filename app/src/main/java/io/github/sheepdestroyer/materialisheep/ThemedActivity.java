...
public abstract class ThemedActivity extends AppCompatActivity {
    ...
    void setTaskTitle(CharSequence title) {
        if (!TextUtils.isEmpty(title)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                ...
                taskDescription = createTaskDescriptionFallback(title.toString(), primaryColor);
            }
    ...
    private ActivityManager.TaskDescription createTaskDescriptionFallback(String title, int primaryColor) {
        return new ActivityManager.TaskDescription(title,
